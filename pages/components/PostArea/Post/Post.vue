				...
				<view class="u-demo-block__content">
					<view class="album">
						...
						<view class="album__content">
							...
							<u--text margin="10px 0 8px 0" @click="toPost" :text="postData.postTitle" ></u--text>
							<u--text margin="0 0 8px 0" text="全面的组件和便捷的工具会让您信手拈来，如鱼得水"></u--text>
							<u-album :urls="urls2" multipleSize=150rpx space="3"></u-album>
					...
					<view class="postInfo">
						...
						<view class="support"><u-icon :firstClick=postData.firstClick 
						:name=postData.supportIcon 
						:label=postData.supportCount
						:id=postData.postId
						@click="support()" 
						></u-icon></view>
				...
				<view class="u-demo-block__content">
					...
					<view class="answerPopup">
						...
						<view class="commentInfo" style="margin-top:5px ;">
							<view class="time"><text>发表时间: {{commentData.commentTime}}</text></view>
							<view class="support"><u-icon :firstClick=commentData.firstClick 
							:name=commentData.supportIcon @click="Support" 
							:label=commentData.supportCount
							:id=commentData.commentId
							></u-icon></view>
							<view class="comment" @click="popup.show=true"><u-icon name='chat' :label=commentData.answerCount></u-icon></view>
						</view>
